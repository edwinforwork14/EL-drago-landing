...
export default function Navbar({ transparentInitially = false, appearOnScroll = false }: NavbarProps) {
  ...
  return (
    <>
      <header
        className={`relative md:fixed top-0 left-0 w-full z-50 flex items-center justify-between py-2 md:py-3 px-6 md:px-10 lg:px-16 transition-all duration-700 ${
