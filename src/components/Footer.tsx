        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-2 md:col-span-1 flex flex-col items-center md:items-start">
            ...
            <div className="flex gap-4">
              <a href="https://www.instagram.com/eldrago.ca?igsh=MXZsbTkxNWQ0c3ZsOA==" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-[#9a0021] text-white rounded-full flex items-center justify-center hover:scale-110 transition-transform shadow-md">
              ...
              <a href="https://www.linkedin.com/company/embutidos-el-drago/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-[#9a0021] text-white rounded-full flex items-center justify-center hover:scale-110 transition-transform shadow-md">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
