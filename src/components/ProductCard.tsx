    ...
    >
      ...
      <div className="p-8 flex flex-col flex-1">
        <div className="flex-1">
          <h3 className="text-primary-dark font-[family-name:var(--font-bebas-neue)] text-3xl tracking-[0.05em] mb-3 leading-none group-hover:text-primary transition-colors">
            {product.name}
          </h3>
        ...
        {/* Action */}
        <button className="group/btn relative w-full overflow-hidden bg-primary py-4 rounded-2xl transition-all duration-300 hover:bg-primary-dark shadow-md hover:shadow-xl">
          <span className="relative z-10 text-white text-lg font-[family-name:var(--font-bebas-neue)] tracking-[0.2em] transition-transform duration-300 group-hover/btn:translate-x-1 inline-block">
            Explorar Selección
          </span>
